...
<body>
	...
	<div class="page-container container-fluid">
		...
		<!-- Page title -->
			...
			<!-- Right labels -->
			<form class="form-horizontal" action="analisa_alternatif_tambah.php" method="post" role="form">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="id_banding" class="form-control" value="<?php echo kdauto('perb_alternatif','A'); ?>" readonly="true" required>
							</div>
						</div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-10">
								<select name='alternatif1' data-placeholder="Pilih Alternatif..." class="required select">
									<option></option>					
										<?php	
						...
						<div class="form-group">
                            <label class="col-sm-2 control-label text-right">Nama Alternatif:</label>
                            <div class="col-sm-10">
								<select name='alternatif2' data-placeholder="Pilih Alternatif..." class="required select">
									<option></option>					
										<?php	
											$query = "SELECT * FROM tbl_mhs";
											$hasil = mysql_query($query);
			...
			if (isset($_POST['simpan'])) {
				...
				$sql = "INSERT INTO perb_alternatif values 
				('$id_banding','$nama','$nilai','$alternatif1','$alternatif2')";
