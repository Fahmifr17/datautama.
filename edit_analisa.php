...
<body>
	...
	<div class="page-container container-fluid">
		...
		<?php $page='analisa_kriteria'; include  "sidebar.php"; ?>
		...
		<div class="page-content">
			...
			$query = mysql_query("SELECT * FROM perbandingan_kriteria WHERE id_kriteria='$id_kriteria'");
			$dataku = mysql_fetch_array($query);
			 ?>
			 <!-- Right labels -->
			 <form class="form-horizontal" action="kriteria_edit.php" method="post" role="form">
			 	<div class="panel panel-default">
			 		<div class="panel-heading"><h6 class="panel-title">ANALISA KRITERIA EDIT</h6></div>
			 		<div class="panel-body">
			 			
			 			
			 			<div class="form-group">
			 				<label class="col-sm-2 control-label text-right">NAMA KRITERIA (KODE KRITERIA):</label>
			 				<div class="col-sm-10">
			 					<input type="hidden" name="id_kriteria" value="<?php echo $dataku['id_kriteria'] ?>">
			 					<input type="text" name="kd_kriteria" value="<?php echo $dataku['nama_kriteria']; ?>" required class="form-control">
			 				</div>
			 			</div>
