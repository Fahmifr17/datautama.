...
<body>
                ...
                <ul class="nav navbar-nav navbar-left-custom">
                    <li class="user dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown">                           
                            <span>Sistem Penunjang Keputusan AHP-SAW</span>                            
                        </a>
                    </li>
	...
	<div class="page-container container-fluid">
		...
		<?php $page='hasil_perhitungan'; include "sidebar.php"; ?>
		...
		<div class="page-content">
			...
			<div class="panel panel-default">
				...
				<div class="">
				<form class="form-horizontal" action="hasil_akhir.php" method="post" role="form">
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr>
								<td colspan="6">
									<div class="text-danger">*Masukkan nilai kriteria AHP pada kolom inputan !</div>
