	...
	<div class="page-container container-fluid">
		...
		<div class="page-content">
			...
			<?php 
				...
				$qa1 = mysql_query("SELECT * FROM perb_alternatif where id_alternatif='A01'");
				$qa2 = mysql_query("SELECT * FROM perb_alternatif where id_alternatif='A02'");
				$qa3 = mysql_query("SELECT * FROM perb_alternatif where id_alternatif='A03'");
				$qa4 = mysql_query("SELECT * FROM perb_alternatif where id_alternatif='A04'");
				$qa5 = mysql_query("SELECT * FROM perb_alternatif where id_alternatif='A05'");
				$b1 = mysql_fetch_array($qa1);
				$b2 = mysql_fetch_array($qa2);
				$b3 = mysql_fetch_array($qa3);
				$b4 = mysql_fetch_array($qa4);
				$b5 = mysql_fetch_array($qa5);
				$qk1 = mysql_query("SELECT * FROM perbandingan_kriteria where id_kriteria='B01'");
				$qk2 = mysql_query("SELECT * FROM perbandingan_kriteria where id_kriteria='B02'");
				$qk3 = mysql_query("SELECT * FROM perbandingan_kriteria where id_kriteria='B03'");
				$qk4 = mysql_query("SELECT * FROM perbandingan_kriteria where id_kriteria='B04'");
				$qk5 = mysql_query("SELECT * FROM perbandingan_kriteria where id_kriteria='B05'");
				$bk1 = mysql_fetch_array($qk1);
				$bk2 = mysql_fetch_array($qk2);
				$bk3 = mysql_fetch_array($qk3);
				$bk5 = mysql_fetch_array($qk5);
				$bk4 = mysql_fetch_array($qk4);

			// menghitung jumlah data pada table mhs untuk menentukan RC
			$data = mysql_query("SELECT * FROM tbl_mhs ORDER BY id_mhs");
			$jml_data = mysql_num_rows($data); //menentukan jumlah data yg ada pada tabel tbl_mhs
			if ($jml_data==1) {
				$rc = 0.00;
			}elseif ($jml_data==2) {
				$rc = 0.00;
...
?>
			...
			<div class="panel panel-default">
				<div class="panel-heading"><h6 class="panel-title">HASIL ALTERNATIF IPK</h6></div>
				<div class="">
			...
			<!-- Hover rows data table inside panel total kolom -->
			<div class="panel panel-default">
				<div class="panel-heading"><h6 class="panel-title">HASIL ALTERNATIF PENGHASILAN ORTU</h6></div>
				<div class="">
					<table class="table table-hover">
						<thead>
							<tr>
			...
			<!-- Hover rows data table inside panel total kolom -->
			<div class="panel panel-default">
				<div class="panel-heading"><h6 class="panel-title">HASIL ALTERNATIF TANGGUNGAN</h6></div>
				<div class="">
					<table class="table table-hover">
						<thead>
							<tr>
			...
			<!-- Hover rows data table inside panel total kolom -->
			<div class="panel panel-default">
				<div class="panel-heading"><h6 class="panel-title">HASIL ALTERNATIF SEMESTER</h6></div>
				<div class="">
					<table class="table table-hover">
						<thead>
							<tr>
			...
			<?php 
			$query = mysql_query("SELECT * FROM pw_kriteria ORDER BY id DESC LIMIT 1");
			$q_pw = mysql_fetch_array($query);
			?>

			<!-- Hover rows data table inside panel total kolom -->
			<div class="panel panel-default">
				<div class="panel-heading"><h6 class="panel-title">ATRIBUTE</h6></div>
				<div class="">
